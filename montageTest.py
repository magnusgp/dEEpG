...
if __name__ == "__main__":
    ...
    sample=nedc_load_edf(edf_path)

    fsamp_sel, sig_sel, labels_sel=nedc_select_channels(params,sample[0],sample[1],sample[2])

    sample_mon=nedc_apply_montage(params,fsamp_sel,sig_sel,labels_sel)
